...
const unsigned char rpro_data [] = {
	 ...
	 0x07,0xf7,0xf7,0xf7,0xc1,0xff,     /* 4 */
	 0x0d,0x6d,0x6d,0x6d,0xe1,0xff,     /* 5 */
	 0x01,0x5d,0x5d,0x5d,0xc1,0xff,     /* 6 */
	 0x3f,0x7f,0x7f,0x7f,0x01,0xff,     /* 7 */
	 0x01,0x6d,0x6d,0x6d,0x01,0xff,     /* 8 */
	 0x07,0x75,0x75,0x75,0x01,0xff,     /* 9 */
}

void setupFontrpro(fontInfo *font){
	if(font != nullptr){
		font->fontIndex = 13;
		strncpy(font->fontName, "R Pro", 6);
...
Using image: '13_RPro.png' size (60, 9), unicode from 48 to 57/57, grayscale threshold: 127, converted by ImageBinarization.
