...
static const unsigned char font_rsidy_data [] = {
	 0x01,0x7d,0xff,0x7d,0x01,0xff,     /* 0 */
	 0xff,0xff,0x01,0xff,0xff,0xff,     /* 1 */
	 0x61,0x6d,0xff,0x6d,0x0d,0xff,     /* 2 */
	 0x6d,0x6d,0xff,0x6d,0x01,0xff,     /* 3 */
	 0x0f,0xef,0xff,0xef,0x01,0xff,     /* 4 */
	 0x0d,0x6d,0xff,0x6d,0x61,0xff,     /* 5 */
	 0x01,0x6d,0xff,0x6d,0x61,0xff,     /* 6 */
...
Using image: '24_RSidy.png' size (60, 9), unicode from 48 to 57/57, grayscale threshold: 127, converted by ImageBinarization.
